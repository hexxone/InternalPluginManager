...
public class CommandEventManagerTest {
    ...
    public void test() {
        ...
        Assert.assertTrue(testEvent(new CommandEvent(CommandEventManagerTestClass1.getCommandEventData())));
        Assert.assertFalse(testEvent(new CommandEvent(CommandEventManagerTestClass2.getCommandEventData())));
        ...
        Assert.assertFalse(testEvent(new CommandEvent(CommandEventManagerTestClass1.getCommandEventData())));
        Assert.assertTrue(testEvent(new CommandEvent(CommandEventManagerTestClass2.getCommandEventData())));
