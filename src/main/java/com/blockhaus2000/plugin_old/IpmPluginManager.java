...
public class IpmPluginManager implements Iterable<IpmPluginData> {
    ...
    private final Set<IpmPluginData> plugins = new HashSet<IpmPluginData>();
    ...
    public static IpmPluginManager getInstance() {
        if (IpmPluginManager.instance == null) {
            IpmPluginManager.instance = new IpmPluginManager();
        }

        return IpmPluginManager.instance;
    }
