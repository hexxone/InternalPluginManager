...
public class IpmPluginLoader {
    ...
    public IpmPluginDescriptionFile loadPlugin(final String pluginName) throws PluginNotFoundException,
            InvalidPluginDescriptionException, PluginException, IOException {
    ...
    public static IpmPluginLoader getInstance() {
        if (IpmPluginLoader.instance == null) {
            IpmPluginLoader.instance = new IpmPluginLoader();
        }

        return IpmPluginLoader.instance;
    }
}
