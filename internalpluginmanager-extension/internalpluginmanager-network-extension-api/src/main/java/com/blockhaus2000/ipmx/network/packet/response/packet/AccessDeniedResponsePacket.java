...
/**
 * Represents the response that is sent if the access is denied by the server.
 *
 */
public class AccessDeniedResponsePacket implements ResponsePacket {
    ...
    public byte[][] getResponseData() {
        ...
        responseData[0] = BitUtil.toByteArray(PacketID.RESPONSE_ACCESS_DENIED.getId());
    ...
    public PacketID getPacketID() {
        return PacketID.RESPONSE_ACCESS_DENIED;
    }
}
