...
public abstract class AbstractFileConfiguration {
    ...
    /**
     * Delegates to {@link AbstractFileConfiguration#getString(String, String)}
     * with <code>path = path</code> and <code>def = null</code>.
     *
     * @param path
     *            Is passed into
    ...
    /**
     * Delegates to
     * {@link AbstractFileConfiguration#getStringList(String, List)} with
    ...
    /**
     * Delegates to
     * {@link AbstractFileConfiguration#getBoolean(String, boolean)} with
    ...
    /**
     * Delegates to {@link AbstractFileConfiguration#getInteger(String, int)}
     * with <code>path = path</code> and <code>def = -1</code>.
     *
     * @param path
     *            Is passed into
     ...
     * @param path
     *            Is passed into
     *            {@link AbstractFileConfiguration#getLong(String, long)} .
    ...
    /**
     * Delegates to {@link AbstractFileConfiguration#getDouble(String, double)}
     * with <code>path = path</code> and <code>def = -1</code>.
     *
     * @param path
     *            Is passed into
